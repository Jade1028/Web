<div class="slider">
    <div class ="list">
        <div class ="item">
            <img src="/Web/images/img1.png" alt="image" title="New book arrival">
        </div>
        <div class ="item">
            <img src="/Web/images/img2.png" alt="image" title="Discount">
        </div>
        <div class ="item">
            <img src="/Web/images/img3.png" alt="image" title="Back to school">
        </div>
   </div>
